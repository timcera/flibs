...
!
!     This version uses integers as the data type for the keys
!
!     TODO:
!     - delete_key
!
...
!start module balanced_trees
    ...
    integer, parameter, private :: undefined_key = -huge(undefined_key)

    public :: tree_data

    type, public :: balanced_tree
        private
        integer :: key = undefined_key  ! Initialise to some improbable number
        type(tree_data) :: data
