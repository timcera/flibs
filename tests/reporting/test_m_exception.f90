...
contains
  ...
  subroutine test_m_exception_all ()
    ...
    call log_startup ( log_unit_newunit, "test_m_exception.log" )
    call assert_startup ( )
    !
    ...
    call exception_raiseFailure (  "This is my message" )
    !
    ! Set the exception unit to a LUN generated by newunit and generate an error.
    !
    call exception_setlogunit ( log_unit_newunit )
    current_logunit = exception_getlogunit ()
    call assert ( current_logunit == log_unit_newunit , "Wrong log unit" )
    call exception_raiseFailure (  "This is my message" )
    !
  ...
  !   Startup logger
  !
  subroutine log_startup ( funit, filename )
    implicit none
    integer, intent(in out) :: funit
