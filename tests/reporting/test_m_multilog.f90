! test_m_multilog.f90 --
!     Small test program for the multiple logs utility. Basted on the
...
program test_multilogging
  ...
  call log_cget ( log_warning, "logfileunit" , logunit)
